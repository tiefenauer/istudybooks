...
class phpDocumentor_setup
{
    ...
    function readConfigFile($file)
    {
        ...
        } else
        {
            ...
            {
                $configdir = str_replace('\\','/', '/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data/PhpDocumentor') . PATH_DELIMITER . 'user' . PATH_DELIMITER;
            } else {
    ...
    function parseIni()
    {
        ...
        if ('/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data' != '@'.'DATA-DIR@')
        {
            $options = phpDocumentor_parse_ini_file(str_replace('\\','/', '/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data/PhpDocumentor') . PATH_DELIMITER . 'phpDocumentor.ini',true);
            phpDocumentor_out("   (found in " . '/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data/PhpDocumentor' . PATH_DELIMITER . ")...\n");
        } else {
