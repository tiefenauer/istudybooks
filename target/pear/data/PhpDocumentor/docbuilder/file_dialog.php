...
if ('/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data' != '@'.'WEB-DIR@')
{
    /**
    ...
    */
    ...
    require_once( '/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data' . PATH_DELIMITER . 'PhpDocumentor/docbuilder/includes/utilities.php' );
    ...
    $ini = phpDocumentor_parse_ini_file('/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data' . PATH_DELIMITER . 'PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
        $configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
        $configdir = '/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data' . PATH_DELIMITER . 'PhpDocumentor/user';
    }
} else {
