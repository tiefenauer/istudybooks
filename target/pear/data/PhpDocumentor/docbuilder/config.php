...
if ('/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data' != '@'.'DATA-DIR@')
{
    $root_dir = 'PhpDocumentor';
    $path = '/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data/PhpDocumentor/docbuilder/images/';

    /**
    * common file information
    */
    include_once("PhpDocumentor/phpDocumentor/common.inc.php");
    include_once("/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data/PhpDocumentor/docbuilder/includes/utilities.php" );

    // find the .ini directory by parsing phpDocumentor.ini and extracting _phpDocumentor_options[userdir]
    $ini = phpDocumentor_parse_ini_file('/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data/PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
    	$configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
    	$configdir =  '/Users/roman/RomanFiles/Homepages/istudybooks/target/pear/data/PhpDocumentor/user';
    }
} else {
